...
def main():
    ...
    if os.path.exists(config_proj["exp"]):
        os.mkdir(config_proj["exp"])
    ...
    if config_proj["Input"]["valid_set"] != "none":
        ...
        valid_txt = None
    # need to change
    test_sets = config_proj["data_preprocess"]["test_sets"].split()
    ...
    scales = [[0.9,0.05,0.05,0,0.0],[0.7,0.1,0.1,0.05,0.05],[0.5,0.15,0.15,0.1,0.1],[0.3,0.2,0.2,0.15,0.15],[0.1,0.25,0.25,0.2,0.2],[0.05,0.15,0.2,0.3,0.3],[0,0.1,0.1,0.4,0.4]]
